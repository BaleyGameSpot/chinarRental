...
fun PaymentsScreen(navController: NavController) {
    Scaffold(
        ...
        Box(
            ...
            Text("Payments & Advance Management")
        }
    }
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun RoznamchaScreen(navController: NavController) {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text("Roznamcha (Daily Ledger)") },
                navigationIcon = {
                    IconButton(onClick = { navController.navigateUp() }) {
                        Icon(Icons.Default.ArrowBack, "Back")
                    }
        ...
        Column(
            ...
            Text("Daily Income & Expense Tracking with Charts")
...
fun RemindersScreen(navController: NavController) {
    Scaffold(
        ...
        Box(
            ...
            Text("Reminders with SMS & Notification Support")
        }
    }
}
...
fun BillsScreen(navController: NavController) {
    Scaffold(
        ...
        Box(
            ...
            Text("Bill Management with PDF Export & Image Upload")
        }
    }
}
